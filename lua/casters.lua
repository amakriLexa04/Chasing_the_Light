...
local skills_haralin = {
	...
	-------------------------
		...
		[2] = {
			...
			subskills   = {
				[1]={ id="skill_summon_mud",     xp_cost=8, gold_cost=10,  label="  <span>Mud (<span color='#FFD700'><i >10g</i></span> <span color='#00bbe6'><i>8xp</i></span>)</span>   " },
...
local skills_daeola = {
	...
	[2] = {
		...
		[2] = {
			...
			description = _"<span color='#6ca364'><i><b>Spell:</b></i></span> Spend <span color='#00bbe6'><i>10xp</i></span> to TEST place ward radius 2.",
			xp_cost=10,
		},
	},
