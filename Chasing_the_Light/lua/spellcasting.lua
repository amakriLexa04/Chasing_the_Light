...
function display_skills_dialog(selecting)
	...
	local apprentice = ( wesnoth.units.find_on_map({ type="haralin L1" }) )[1]
	...
	wesnoth.interface.select_unit() -- deselect haralin
...
wesnoth.game_events.on_mouse_action = function(x,y)
	...
	if (not selected_unit[1] or selected_unit[1].id~='haralin') then return end
